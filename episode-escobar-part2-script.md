# PART 2 SCRIPT v2 — "Bringing Pablo Escobar to 2026" (SHOT-BY-SHOT EDIT BLUEPRINT)

**Status: DRAFT v2 — awaiting owner approval.** Rebuilt per the same v5 correction
...
per-chapter music states. Approved dialogue unchanged. Same style prefix + wardrobe
...
## SCENE 1 · THE ANSWER — the morph oner · 12s · MUSIC: low riser through the morph
| # | Shot (dur) | Camera & content | Cut out |
|---|---|---|---|
| 1.1 (2s) | **Part 1's final frame continued** — his eyes, held. Then, quietly: {Pablo: "Show me."} | hard |
| 1.2 (6s) | **THE SIGNATURE ONER (the series' one unbroken move):** her hand takes his; slow push WITH them through the gate arch — and inside the single framing 1987 MORPHS to 2026: same gate, same mounted plane — now ticket booth, tour buses, families in shorts. Audio morphs with it: crickets → reggaeton, kids, <ticket-scanner beep>. Banner ON. (Production: first/last-frame anchored morph; 1987 side chains from Part 1 10.5.) | hard |
...
| 4.1 (2s) | **Café wall-screen insert:** an unbranded TV drama — an actor in a mugshot pose. Muffled screen dialogue. | hard |
| 4.2 (4s) | **Over-his-shoulder slow push toward the screen,** his out-of-focus profile huge in foreground (the romanticized-art-vs-reality staging): {Pablo: "That is not me."} {Hazel: "It's the version of you the whole world watches."} | hard |
| 4.3 (4s) | **His reflection ghosted ON the screen over the actor's face,** tight: (beat — his own prophecy landing) {Pablo, quiet: "…They say my name."} {Hazel: "Every day."} | hard → S5 river light |

## SCENE 5 · THE HIPPOS — the series payoff · 12s · MUSIC: the warm piano figure returns (only reprise)
| 5.1 (3s) | **High wide (her Joan-parade aerial grammar):** a wide brown river at golden hour — HIPPOS AT EVERY DEPTH: individuals near, groups mid, shapes far; calves among them. Continuous motion (§17). <layered deep grunts near/far> | hard |
| 5.2 (5s) | **Bank-level lateral, the two in silhouette against the water:** {Hazel, quiet: "Your four. Over a hundred now. Nobody could ever move them."} | hard |
| 5.3 (4s) | **His profile close** — pride and something colder crossing it; his eyes drop to the water's edge: {Pablo, quiet: "They survived me."} | hard → S6 |

## SCENE 6 · THE WALL — his first silence · 14s · MUSIC: NOTHING touches this scene
| 6.1 (3s) | **Locked wide:** a memorial wall, candles at its base; the two small against it. No tourists. (No legible real names — roles and ages carry it.) | hard |
| 6.2 (6s) | **Her slow drift along the wall as she reads,** candlelight: {Hazel, plain: "He was a judge. She was a journalist. He was a police cadet. There are thousands of them."} | hard |
| 6.3 (5s) | **His static single:** fixed on one point of the wall. {Hazel, off: "Say something."} He looks away. Nothing. Candle flicker, wind, <a single far church bell>. | hard → S7 |
(Proximity-escalation law: S6–S8 hold the longest, stillest shots of the series.)

## SCENE 7 · THE ROOFTOP · 20s · MUSIC: silence; one low note under "Then I win."
| 7.1 (3s) | **His turned profile at the wall,** finally: {Pablo, not looking at her: "You said you would show me how it ends."} | hard |
| 7.2 (4s) | **The street reveal, slow tilt up:** an ordinary narrow street, ordinary houses, laundry moving on a line <soft cloth> — one ordinary tiled roof against the evening. {Hazel: "Here. December second, nineteen ninety-three. One day after your birthday."} | hard |
| 7.3 (5s) | **Shot-reverse singles:** {Pablo, after a long moment: "Can it be changed?"} {Hazel: "It already happened. I'm here so you see it."} | hard |
