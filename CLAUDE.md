...
is marked. Latest owner decisions recorded: 2026-08-23 (word-synced chunk
caption system, supersedes full-line cues for ALL episodes — see the Caption
system section below), 2026-08-22 (ask before every clip regeneration + send
every clip to the owner for approval, reinforced: sending the clip is never
gated behind Claude's own findings — see the QC rule below).
