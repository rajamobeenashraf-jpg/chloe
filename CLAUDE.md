...
Alexander/Gaugamela: his voice-identity lock reference is Higgsfield media `0edb4d2d-835d-4264-a7ce-9d9b05c97059`, extracted from the owner-approved Clip 3 v4 (his first line, 0:01-0:06.8, the cleanest delivery in the episode). Every future Alexander clip in this episode — starting with the still-pending Clip 2 regeneration — must include this reference with a VOICE IDENTITY instruction, not just the tempo-only pacing reference.
