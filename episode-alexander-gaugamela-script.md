...
| 3 | 8s | Arming through the whole beat (retention fix 2026-08-29: motion never stops — he buckles, checks the blade, moves; the scene must not read as two people pausing to chat), a worn scroll-case by the cot — she nods at it. "What's that?" *[Alexander]*, not looking up: "Homer. Aristotle's own copy — he corrected it himself. Sleeps under my pillow. With the dagger." Her: "You brought a book to a war." *[Alexander]*, snapping the last buckle and already moving past her toward the tent flap, the look landing on her mid-stride: "I brought the only book that matters. Achilles didn't get old either. I intend to beat that record too." He's OUT of the tent on the last word — the scene exits into momentum. | Sourced humanizing detail as the empathy core + Troy echo + audit fix: highest skip-risk beat armored with continuous motion and an exit-into-momentum |
...
## RETENTION AUDIT — v9 (per brief §12, AUDIT 1; run 2026-08-29, findings-first)

**Retention map (84s):**
| Beat / time | Viewer question held | New info | Tension | Payoff delivered |
|---|---|---|---|---|
| 1 · 0:00–0:09 | Why are armed guards watching a sleeping man? How does an empire end TODAY? | The clock: empire falls tonight | ▲ | — |
| 2 · 0:09–0:18 | Who is this man who wakes calm before doom? What's HER role here? | The refused night attack; she's the scribe | ▲ | — |
| 3 · 0:18–0:26 | Who IS he really? (character mystery: a book and a dagger) | The Iliad, the Achilles obsession | ▬ hold | — |
| 4 · 0:26–0:36 | How big is this really? What's in the guarded tent? | Army scale; Bucephalus; DARIUS'S FAMILY IS HERE | ▲ | — |
| 5a–5c · 0:36–0:48 | Will the charge reach the gap? What's waiting for it? | The wedge, the target, the braced defenders | ▲▲ | "going WITH them" promise kept |
| 6a–6b · 0:48–0:57 | Does the line break? | It breaks — HERE, visibly | ▲▲▲ peak | The clip-1 promise begins paying |
| 7 · 0:57–1:07 | Where is Darius? What decides it? | The king RUNS; the run is what decides it | ▲▲ → release | The "how" reveal — the episode's answer |
| 8 · 1:07–1:15 | What does this cost? What passed between them? | Wounded inside the celebration; "Get all of it down?" | ▼ warm | Stylus gag + "steal a victory" both pay |
| 9 · 1:15–1:24 | What did it mean? | Dead at 32 — "longer than he thought he'd get" | ▼ still | Empire clock + Achilles/Iliad + frame rhyme all pay |

**Named findings:** strongest hook = the guards-over-a-sleeping-king image (mute-legible mystery). Biggest reveal = clip 7 (the battle is decided by a man running away). Emotional peak = clip 7's mask-drop. Final payoff = death-at-32 over the Achilles plant. **Weakest section / first drop-off risk = clip 3 (0:18–0:26)** — the one beat holding tension flat instead of raising it; classified B (its removal would break clip 9's payoff), FIXED this pass: continuous arming motion through the beat and an exit-into-momentum (he's out of the tent on his last word) so it reads as a scene in motion, not a pause. **Skip-test:** no 5–10s stretch survives skipping without losing a payoff the viewer later needs — every clip plants or pays. **Cheap-trick check:** clean — the stated-doom open is the channel's deliberate known-outcome structure (suspense = HOW + what she witnesses), not clickbait. **Clip classifications:** A = 1, 2, 4, 5a, 5b, 6a, 7, 8, 9 · B = 3 (fixed), 5c · C-by-content/A-by-rhythm = 6b (3s percussive function). No D-class clips.

**AUDIT 2 (scale):** passes on paper — scale bible, density floors, evolution stages all specified; real verification happens on frames. **AUDIT 3 (performance):** passes — intensity maps exist for the peak; remaining clips get theirs at prompt-writing. **AUDIT 4 (filmmaking):** passes — edit map, geometry traces pending per-clip at stage 8. Gate status: cleared for stage 8 whenever production is greenlit.
