# Episode DRAFT v8 — "The Day Alexander Ended an Empire" (Gaugamela, October 1, 331 BC)
...
| 5b | 5s | **[V]** Hard cut to her own lens: tight, jostled, bodies passing both frame edges, the front NOT in frame behind her. Breath ragged before she speaks: "We're not staying back. We're going WITH them." Ends on her head snapping toward off-frame right — the eyeline that launches clip 6. | Reaction half + stitching-grammar eyeline handoff into the next Nova beat |
| 6 | 10s | **[NOVA — PROPOSED, owner approval pending]** THE IMPACT — what she just looked toward: LOCKED static third-person frame from the Macedonian side; the wedge drives into the gap from frame-left; the Persian line buckles at the contact point — shields dropping, spears turning, men and horses falling (§24-compliant, non-graphic), the break propagating visibly outward. Full-battle stage per the scale bible: heavy dust, both lines running past both frame edges, midground hundreds/background thousands. §33: gear never crosses sides. No dialogue. | The mute-legibility keystone — "the line broke HERE" readable by construction; the case for/against a V-mode alternative is argued in the breakdown for the owner's call |
| 7 | 11s | **[V]** DARIUS FLEES — opens ON her face (the §37a reaction, moved here from old clip 6): scleral show, mouth dropping to a full "O," hands rising then clamping the tablet, shoulders pulling in. She half-turns; deep in frame the distinct chariot-and-standard wheels hard and recedes; nearby Persians glance toward it, one beat, then break and run — the collapse streaming past her on both sides, wounded among them, equipment underfoot. Breathless: "...That's him. He's LEAVING. And now everyone else is too." | Exit-Nova-into-her-reaction stitching rule + the domino told in glances + geometrically honest recession |
...
**Total: 9+9+8+10+5+5+10+11+8+9 = 84s.** Runtime unchanged; v8 redistributed 2s inside the battle sequence (5b +1, 6 −2, 7 +1) to carry the moved reaction beat.
