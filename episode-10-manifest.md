...
| 10 | **Clip 1 v4** — same dialogue/pacing as v3, added hard camera-distance-lock guard + reinforced no-eye-makeup guard | video-generation | `assets/clip1_v4.mp4` | Sent to owner 2026-08-26 — awaiting approval. Self-QC: camera-jump FIXED (verified across full clip via frame extraction). Makeup guard FAILED — visible eye makeup present from frame 1 onward this time (different failure mode than v3's mid-clip drift); flagged to owner as a finding, not yet resolved |
