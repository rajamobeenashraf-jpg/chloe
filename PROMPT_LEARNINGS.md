...
| N11 | **Seedance's video filter also refuses a near-nude male figure DOMINATING the frame, even alone, unarmed-of-context and doing nothing violent — configurational again, not lexical.** Found 2026-09-02 (Spartacus arena, S1). The same gladiator, same kit, same start-frame pipeline: **S5 PASSED** (`12d59df1`) with him as one of two figures, clothed woman beside him, both smaller in frame; **S1 FAILED TWICE with explicit `nsfw`** (`677cb98e`, then `1e7a2a97`) with him ALONE, running, in a medium shot from mid-thigh up wearing only a leather subligaculum. The second attempt stripped every body-focused phrase ("bare torso flexes with the effort, sweat catching the light", "his torso and shoulders are bare") and still failed — so wording was not the variable. Note the STILLS filter passed the identical composition (`3f6dd374`), so the video filter is STRICTER than the stills filter on this axis and a clean start frame is no guarantee the clip will render. **Working hypothesis (not yet isolated):** proportion of frame occupied by an unclothed male torso. **Untested fixes, cheapest first:** (a) widen the framing so he occupies less of the frame; (b) add a garment to his design — costs continuity with the already-approved S5; (c) change the angle so the shot is less torso-dominant. **Rule: a passing still does NOT license the clip — budget for the video filter refusing shots the stills filter allowed, and stop after ONE retry (per N9) rather than iterating.** | `12d59df1` (pass, two figures) vs. `677cb98e` + `1e7a2a97` (both nsfw, him alone); still `3f6dd374` passed | 2026-09-02 |
| N10 | **`nano_banana_2`'s combat boundary, located by isolating test (2026-09-01, Spartacus arena): two-character fight shots PASS; "woman on the ground with an armed man standing over her" FAILS, and no wording rescues it.** Three tests, one variable each: Hazel alone standing armed — PASS (`47cf1886`); Hazel + Spartacus both standing several feet apart, weapons lowered — PASS (`0a92af47`); Hazel down on the sand with Spartacus upright behind her — FAIL (`49619073`), despite fully neutral N9-compliant wording, spear held vertical and planted, "alert and steady, not crying, not cowering", and explicit "no blood, no wounds, no weapon touching anyone". **So the refusal is CONFIGURATIONAL, not lexical** — N9's prompt-wording rule is necessary but not sufficient, and a prone-woman/standing-armed-man composition should be treated as simply unavailable rather than something to re-word. **Design implication:** stage a defeat beat with the losing character ALONE in frame (which is what the Troy reference itself does — Hector falls alone, Achilles is never shown over him in those 22s), and keep both figures upright whenever they share a frame. **Contact resolved (`0221fd5b`, 2026-09-01):** weapon-on-shield contact between two UPRIGHT figures PASSES — his spear shaft driven flat against her raised bronze shield, both braced on their feet. So the discriminator really is prone-vs-upright, not violence-vs-none. Write BOTH STANDING UPRIGHT explicitly and confine contact to weapon-against-shield, never weapon-against-person. **Seedance video filter CLEARS the same content (2026-09-02, job `12d59df1`):** a 5s `seedance_2_5` `omni_reference` clip of the S5 shield-clash, generated audio on, rendered without objection — two armed characters, weapon driven against shield, real combat motion. So the both-upright / weapon-on-shield-only discipline transfers from the stills filter to the video filter unchanged, and armed two-character combat is fully available in both halves of the pipeline. | `47cf1886`, `0a92af47` (pass) vs. `49619073` (fail) | 2026-09-01 |
