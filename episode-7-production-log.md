...
**Owner follow-up questions on the v2 cut, 2026-08-21:** (1) why keep Krethon as an intermediary at all rather than have her approach and address Achilles directly herself; (2) what the "he's shorter than you'd think" line is actually supposed to mean. Answered in chat, not yet resolved into a v3 — see next revision round once owner responds.
