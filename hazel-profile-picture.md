...
**Round 7 (owner request): CLEAN GIRL makeup with a bold-lip override, default canonical sheet, PAI Pro.** Dewy minimal-coverage base (freckles fully visible — the shoot's best freckle fidelity), brushed feathered brows, cream blush, no heavy liner/lashes — with the owner's single specified exception: a bold sharply-defined glossy classic-red lip (explicitly overriding the nude-caramel lip-tint clause for these portraits; lip shape/fullness locked). Butterfly Cut retained.
- **Beach** — white linen-silk dress, golden hour, breeze-lifted hair, joyful smile. QC ✅ identity, freckles excellent.
- **Drawing room** — cream ribbed cashmere, afternoon light, sofas/brass lamps/white flowers. QC ✅ identity, freckles visible, hands clean.
Delivered in chat only; regenerate from these settings if lost. The profile-shoot series now spans: Soft Glam (Soul/Nano/PAI incl. the lawn pick), Full Glam (v5 + canonical A/B pairs), Clean Girl + bold lip (this round).

**Round 8 (owner request): Facebook cover + luxury-western 4-look shoot.** Canonical sheet refs, filter-safe identity framing, PAI Pro at native 720×1280 (9:16 supported). One IDENTICAL background across all four (golden-hour Southwest red-rock vista, stated verbatim per prompt): Look 1 Denim & Diamonds (white shorts, gold+diamond, loose waves) · Look 2 Suede & Turquoise fringe (denim shorts, turquoise-silver, high ponytail) · Look 3 The Black Hat (leather shorts, gold-buckle belt + layered gold, side-swept waves under the hat) · Look 4 Desert Boho (linen shorts, gold+pearl, side braid) — all Soft Glam tone-matched to each outfit, freckles visible. One filter trip on Look 4's original "crochet-lace" wording, passed after rewording to "bohemian knit blouse." QC ✅ identity across all four. **Cover assembled at 1640×624** (2× of Facebook's 820×312 desktop display; meets the ≥851×315 upload spec): four panels cropped 720×1104 → 407×624, 4px white dividers. Display notes for the owner: desktop shows the full strip; MOBILE crops to a taller center window so the middle two looks show fully and the outer two partially (standard for collage covers); the circular profile photo overlaps the lower-left of panel 1 on desktop. All five files delivered in chat only.

**Owner decision pending:** final profile picture pick (lawn recommended among soft-glam takes; rounds 5–8 are the styled/branding alternates) + whether these styled looks appear anywhere beyond profile/branding assets.
